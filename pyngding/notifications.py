...
def send_webhook(url: str, payload: Dict, secret: Optional[str] = None, timeout: int = 3) -> bool:
...
def send_ntfy(base_url: str, topic: str, message: str, title: Optional[str] = None,
              priority: int = 3, tags: Optional[List[str]] = None,
              auth_mode: str = 'none', username: Optional[str] = None,
...
def create_notification_payload(event_type: str, ip: str, mac: Optional[str] = None,
                               hostname: Optional[str] = None, vendor: Optional[str] = None,
                               label: Optional[str] = None, is_safe: bool = False,
                               tags: Optional[str] = None, extra: Optional[Dict] = None) -> Dict:
...
def send_notification(db_path: str, event_type: str, ip: str, mac: Optional[str] = None,
                     hostname: Optional[str] = None, vendor: Optional[str] = None,
                     label: Optional[str] = None, is_safe: bool = False,
                     tags: Optional[str] = None, extra: Optional[Dict] = None) -> Dict[str, bool]:
