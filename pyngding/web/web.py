...
from pyngding.core.db import get_all_hosts, get_db, get_recent_scan_runs
...
def create_app(config: Config, db_path: str, scheduler: ScanScheduler) -> Bottle:
    ...
    def admin_settings_update():
        ...
        from pyngding.web.settings import DEFAULTS, sanitize_setting, validate_setting
    ...
    def admin_adguard():
        ...
        from pyngding.core.db import get_adguard_state
        from pyngding.web.settings import DEFAULTS
